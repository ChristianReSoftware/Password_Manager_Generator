...
namespace Password_Management
{
    public partial class ChangePassForm : Form
    {
        ...
        public ChangePassForm(PasswordSaveWrite passwordSaveWrite, string filePath)
        {
            //InitializeComponent();
        ...
        private void InitializeComponents()
        {
            ...
            button2.Click += ButtonCance_Click;
        ...
        {
            helper.changePass(textBox_website.Text, textBox_passwort.Text, filePath);
        }
        ...
        private void ButtonGennerate_Click(object sender, EventArgs e)
        {
            ...
            string ding = RandomPassword(random, 6);
            textBox_passwort.Text = ding;
        }
    }
}
